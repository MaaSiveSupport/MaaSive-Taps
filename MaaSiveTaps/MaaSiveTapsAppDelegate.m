...
#import "MaaSiveTapsAppDelegate.h"
#import "RootViewController.h"

@implementation MaaSiveTapsAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MaaSiveTaps" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MaaSiveTaps.sqlite"];
